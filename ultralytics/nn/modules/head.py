...
__all__ = "Detect","Detect_3D", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "v10Detect"
# total_3D
class Detect_3D(nn.Module):
    ...
    def forward(self, x):
        ...
        feat=[]
        for xi in x:
            xi = xi.permute(0, 2, 1, 3, 4)  # [batchsize, depth, c, H, W]
            C, H, W = xi.shape[2], xi.shape[3], xi.shape[4]
            xi = xi.reshape(-1, C, H, W)  # [batchsize*depth, c, H, W]
            feat.append(xi)
        x=feat
